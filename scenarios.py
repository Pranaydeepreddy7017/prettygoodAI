...
SCENARIOS = {
    ...
    # the first few are creative or complex scenarios to test agents capabilities, there are some more straightforward ones at the end to test basic functionality.
    # To test a specific scenario, comment out the others and run a single call to ensure that scenario is selected.
    "double_booking":(
